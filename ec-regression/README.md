...
Target Product: standalone java project
...
Command in cmd console:  mvn clean package  

Or by Eclipse selections:  
right click the pom.xml -> run as -> Maven Build (clean package) 

ECRegression.jar will be build andec-regressionproject root directory
